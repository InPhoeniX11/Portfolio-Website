...
export const secretKey = process.env.SECRET_KEY || "dev-secret-key";                                                                                // export let secretKey = process.env.SECRET_KEY;
export const port = Number(process.env.PORT) || 5000;                                                                                // export let port = process.env.PORT;
export const dbUrl = process.env.DB_URL || "";                                                                                // export let dbUrl = process.env.DB_URL;
